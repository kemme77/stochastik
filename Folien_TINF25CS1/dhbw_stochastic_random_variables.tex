...
\end{block}
\begin{block}{Wahrscheinlichkeit als Erwartungswert}
\[
...
\begin{frame}
\includegraphics[scale=0.09]{img/sphere_slicing.jpg}
...
\[
\mathbb P(A)=\int_A p(x)\,d\lambda(x).
\]
\end{block}
\end{frame}
...
\end{block}
 ...
 \begin{frame}
        \frametitle{Zufallsvariablen}
\framesubtitle{}
    \includegraphics[scale=0.4]{img/normal.png}
        \includegraphics[scale=0.4]{img/normaldist.png}
